...
\textcolor{red}{soccer simulations NAO webbots (weebots)\\ multi agent simulation without robots}
...
\textcolor{red}{of course documentation}
...
\item Cpomarison of different multi-robot strategies
\end{itemize}\\
\hline
\end{tabular}
\label{Table 1}
...
Of course there will be regular discussions with my advisor to get feedback and advice.

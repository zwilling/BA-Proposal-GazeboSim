...
The \textit{Microsoft Robotics Developer Studio}~\footnote{www.microsoft.com/robotics} is free for noncommercial use and bound to Microsoft Windows. Besides the simulation it offers standartization for robotic control and several tools for robot development~\cite{MicrosoftRobotSimulator}.\\
\textcolor{red}{\textit{Robotino Sim Professional}}\\
\textcolor{red}{\textit{OpenSim}}
